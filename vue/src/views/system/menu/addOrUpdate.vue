<template>
    <div>
        ...
        <el-form :model="dataForm" :rules="rules" ref="dataForm" label-width="100px" class="menuForm demo-ruleForm" style="overflow:hidden">
            ...
            <el-form-item label="菜单类型" prop="menuType" style="width:50%;float:left">
                <el-radio-group :disabled='id?true:false'  v-model="dataForm.menuType">
                    <el-radio label="M">目录</el-radio>
                    <el-radio label="C">菜单</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="菜单图标" class="selectIcon" style="width:50%;float:left">
                <span class="spanIcon">
            ...
            <el-form-item label="菜单名称" prop="menuName" style="width:50%;float:left">
            ...
            <el-form-item label="路由地址" prop="path" style="width:50%;float:left">
        ...
        handleTree(data, id, parentId, children, rootId) {
            ...
            const treeData = cloneData.filter(father => {
                let branchArr = cloneData.filter(child => {
                    //返回每一项的子级数组
                    return father[id] === child[parentId] && child.menuType === 'M'
                });
