        ...
        <el-table :data="dataList" style="width: 100%;margin-bottom: 20px;" :header-cell-style="{'background-color':'#f8f8f9'}"
            ...
            <el-table-column fixed="right" label="操作" width="150">
                <template slot-scope="scope">
                    <el-button @click="addOrUpdate(scope.row.deptId)"  type="text" size="small"><i id="del" class="el-icon-edit"></i> 修改</el-button>
                    <el-button type="text" size="small" v-if="scope.row.son==='N'" @click="delMenu(scope.row.deptId)"><i id="del" class="el-icon-delete"></i> 删除</el-button>
                </template>
            </el-table-column>
        </el-table>
